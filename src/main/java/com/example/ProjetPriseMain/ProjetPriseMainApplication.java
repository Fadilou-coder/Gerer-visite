...
public class ProjetPriseMainApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		service.addEmp(new Employe(null, "employe", "employe", "employe@gmail.com", "771521713", "Emploi et Formation"));
		service.addEmp(new Employe(null, "employe", "employe", "employe1@gmail.com", "771234567", "Emploi et Formation"));
		...
		service.addApp(new Apprenant(null, "zeumb", "zeumb", "123456789099", c.getTime(), c1.getTime(), "dakar"));
		...
		service.addForToApp("Cohorte SA", "1234567890990");
		service.addForToApp("Cohorte SA", "1234577890990");

		service.addStageToStagiaire("Stage Pédagogique", "123456789018");
